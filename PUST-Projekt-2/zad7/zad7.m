...
%Sygnał zakłócenia oberczony szumem:
sigma=0.01;
z = z + normrnd (0 , sigma , kk ,1)' ;
%Uwzględnienie zakłócenia
z_on=1;
...
for k=8:kk
    ...
    %Uwzględnienie lub nie zakłócenia i wyznaczenie dU
    if z_on==1
...
print('pust5_u_N50_Nu25_lambda0,25_sigma0,01.png','-dpng','-r400')

figure;
stairs((1:kk),z);
title("z"); xlabel('k'); ylabel('z');
print('pust5_zakłócenie_sigma0,01.png','-dpng','-r400')
...
legend('y','yzad');
title("y, E="+ num2str(E))
print('pust5_y_N50_Nu25_lambda0,25_sigma0,01.png','-dpng','-r400')
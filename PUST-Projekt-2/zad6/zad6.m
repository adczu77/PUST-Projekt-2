...
%Sygnał zakłócenia jako przebieg sinusoidalny:
vector=(0:0.1:kk);
for k = 1: kk
    if(k <= 100 )
        z ( k ) = Zpp;
    else
        z ( k ) = 0.5*sin (vector(k-100)) ;
    end
end
...
print('pust5_u_N200_Nu100_lambda1_z.png','-dpng','-r400')

figure;
stairs((1:kk),z);
title("z"); xlabel('k'); ylabel('z');
%print('pust5_zakłócenie.png','-dpng','-r400')
...
legend('y','yzad');
title("y, E="+ num2str(E))
print('pust5_y_N200_Nu100_lambda1_z.png','-dpng','-r400')